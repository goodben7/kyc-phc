...
class StatAgentsByGenderProcessor  implements  ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): StatResource
    {
        if (empty($data->siteId)) {
            $agentStats = $this->agentRepository->countAgentsByGender(null);
        } else {
            ...
            $agentStats = $this->agentRepository->countAgentsByGender($site);
        }
